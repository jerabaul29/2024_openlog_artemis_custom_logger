...
/*
  TwoWireArtemis.h - TWI/I2C library for Arduino & Wiring
...
#ifndef TwoWireArtemis_h
#define TwoWireArtemis_h

#include <Stream.h>
#include "MLX_twi.h"
#ifndef I2C_BUFFER_LENGTH
    #define I2C_BUFFER_LENGTH 128  // Default size, if none is set using WireArtemis::setBuffersize(size_t)
#endif

class TwoWireArtemis : public Stream
{
  private:
