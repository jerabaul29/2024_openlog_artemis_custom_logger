...
#ifdef MLX_SOFTWireArtemis
 #include <SoftWireArtemis/MLX_SoftWireArtemis.h>
 
#else
	#include <WireArtemis.h>
	
	////////////////////////////////////////////////
	// Default I2C PIN for non Atmega Boards      //
	// you may need to change this for your board //
	////////////////////////////////////////////////
	// Artemis V1, UNOR4
	
	#ifndef SDA	
	#define SDA	A4 //PIN_WireArtemis_SDA
	#endif
	
	#ifndef SCL
	#define SCL A5 //PIN_WireArtemis_SCL
	#endif
...
public:
	...
	// begin(<address>) initializes the WireArtemis library, and prepares
	...
	bool begin(uint8_t address = MLX90614_DEFAULT_ADDRESS, TwoWireArtemis &WireArtemisPort = WireArtemis);
